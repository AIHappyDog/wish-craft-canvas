...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      title: "Creator",
      value: "@buy_Ethereums",
      link: "https://twitter.com/buy_Ethereums"
    }
  ];
      ...
      <Helmet>
        ...
        <script type="application/ld+json">
          {`
          {
            ...
            "url": "https://www.manifestmagics.com/contact",
            "contactPoint": {
              "@type": "ContactPoint",

      ...
      <Helmet>
        ...
        <script type="application/ld+json">
          {`
          {
            ...
            "url": "https://www.manifestmagics.com/terms",
            "publisher": {
              "@type": "Organization",
              "name": "Manifest Magic"
            },
            ...
            <CardContent>
              <ScrollArea className="h-[600px] pr-4">
                <div className="space-y-8 text-sm leading-relaxed">
                  ...
                  {/* Creator Information */}
                  <section>
                    <h2 className="text-xl font-semibold text-foreground mb-4">8. Creator Information</h2>
                    <p className="text-muted-foreground mb-3">
